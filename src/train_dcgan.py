...
class Discriminator(nn.Module):
    ...
    def forward_reshape(self,input):
        input_res = torch.nn.functional.interpolate(input,size=(64,64), mode='nearest')
        output = self.main(input_res)
        return output.view(-1, 1).squeeze(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imageWidth', type=int, default=64, help='width of the input image to network')
    parser.add_argument('--imageHeight', type=int, default=64, help='height of the input image to network')
